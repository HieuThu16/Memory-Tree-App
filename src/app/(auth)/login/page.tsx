  ...
  return (
    <div className="glass-card w-full max-w-md rounded-3xl p-8 shadow-[var(--shadow-card)] mx-auto mt-20">
      <div className="flex flex-col items-center justify-center mb-8">
        ...
        <h1 className="mt-3 text-3xl font-medium text-foreground text-center">Đăng nhập</h1>
        <p className="mt-2 text-sm text-text-muted text-center max-w-xs">
          Kết nối bằng Google hoặc nhận magic link để vào khu vườn kỷ niệm của bạn.
        </p>
      </div>
      ...
      <div className="mt-6 flex flex-col gap-5">
        ...
        <div className="relative flex items-center py-2">
          ...
          <span className="flex-shrink-0 mx-4 text-xs tracking-widest uppercase text-text-muted">Hoặc</span>
          <div className="flex-grow border-t border-border"></div>
        </div>
      ...
      {status ? (
        <div className={`mt-6 rounded-2xl p-4 text-[13px] text-center font-medium ${
        ...
        <div className="mt-6 rounded-2xl p-4 text-[13px] text-center font-medium bg-red-500/10 text-red-400 border border-red-500/20" role="status">
