export const MEMORY_SUMMARY_SELECT =
  "id, user_id, room_id, parent_id, title, category, location, date, type, position_x, position_y, created_at";

export const MEMORY_SUMMARY_SELECT_LEGACY =
  "id, user_id, room_id, parent_id, title, category, location, date, type, position_x, position_y, created_at";
